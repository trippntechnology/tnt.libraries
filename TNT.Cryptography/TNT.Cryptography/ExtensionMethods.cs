...
namespace TNT.Cryptography
{
	...
	public static class ExtensionMethods
	{
		...
		/// <summary>
		/// Gets the <see cref="X509EnhancedKeyUsageExtension"/> associated with <paramref name="certificate"/>
		/// </summary>
		/// <param name="certificate"><see cref="X509Certificate2"/> with enhanced extensions</param>
		/// <returns><see cref="X509EnhancedKeyUsageExtension"/> if exist, null otherwise</returns>
		public static X509EnhancedKeyUsageExtension GetEnhancedKeyUsage(this X509Certificate2 certificate)
		{
			if (certificate==null)
			{
				return null;
			...
			return (certificate.Extensions[X509Extensions.ExtendedKeyUsage.ToString()] as X509EnhancedKeyUsageExtension);
		}
